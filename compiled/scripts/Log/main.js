...
const logsLocation = config?.logsLocation || 'logs/';
const logFileName = config?.logFileName || "{month}.{day}.{year} {hour}.{minute}.{second}.log";
var logFile;
function $02d(a) {
    return (a < 10 ? `0${a}` : `${a}`);
}
...
export async function outputLog(...args) {
